...
-   ### Fixed Bugs
    ...
    * [Stack Overflow](https://stackoverflow.com/questions/41747667/bootstrap-4-responsive-tables-wont-take-up-100-width) gave me some valuable information about the responsive table design. I found that the table displaying the shopping bag contents was only responsive to around 380px. I tried to tweak padding/margin etc but user still had to scroll horizontally to view bag contents. I did not feel this was a great UX therefore i decided to add seperate design for small screen sizes and hidden on medium and above. Had i had more time i think i may have removed the table completely and opted for the design i'd used for the smaller screen sizes, however the table does look smart on larger screen sizes. 
